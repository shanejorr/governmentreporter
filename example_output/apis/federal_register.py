    ...
    try:
        ...
        try:
                ...
                search_results.append(
                    {
                        ...
                        "url": doc.url,
                        "metadata_keys": (
                            list(doc.metadata.keys()) if doc.metadata else []
                        ),
                    }
                )
            ...
            results["search_documents"] = {
                ...
                "result": {"count": len(search_results), "documents": search_results},
            }
        except Exception as e:
            results["search_documents"] = {
                "method": "FederalRegisterClient.search_documents()",
        ...
        try:
            ...
            order_iterator = client.list_executive_orders(
                start_date="2024-01-01", end_date="2024-01-31", max_results=3
            )
                ...
                orders.append(
                    {
                        ...
                        "president": (
                            order.get("president", {}).get("name")
                            if isinstance(order.get("president"), dict)
                            else str(order.get("president", ""))
                        ),
                    }
                )
