...
from src.governmentreporter.utils.citations import (
    build_bluebook_citation, format_cfr_citation, format_constitution_citation,
    format_usc_citation, parse_cfr_citations, parse_constitution_citations,
    parse_usc_citations)
...
def main():
    ...
    try:
        ...
        sample_cluster_data = {
            "citations": [
                {"type": 1, "volume": "347", "reporter": "U.S.", "page": "483"},
                {"type": 2, "volume": "98", "reporter": "S.Ct.", "page": "873"},
            ],
    ...
    try:
        ...
        for example in cfr_examples:
            citation = format_cfr_citation(
                example["title"], example["section"], example["year"]
            )
            cfr_results.append({"input": example, "output": citation})
    ...
    try:
        ...
        for example in usc_examples:
            ...
            usc_results.append({"input": example, "output": citation})
    ...
    try:
        ...
        for example in const_examples:
            ...
            const_results.append({"input": example, "output": citation})
    ...
    try:
        ...
        for text in cfr_text_examples:
            ...
            cfr_parse_results.append({"text": text, "citations_found": citations})
    ...
    try:
        ...
        for text in usc_text_examples:
            ...
            usc_parse_results.append({"text": text, "citations_found": citations})
    ...
    try:
        ...
        for text in const_text_examples:
            ...
            const_parse_results.append({"text": text, "citations_found": citations})
