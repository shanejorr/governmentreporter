...
class ProgressTracker:
    ...
    def __init__(self, db_path: str = "ingestion_progress.db", document_type: str = "generic"):
        """
    ...
    def start_run(self, start_date: str, end_date: str, parameters: Dict[str, Any] = None) -> int:
        """
    ...
    def is_processed(self, document_id: str) -> bool:
        ...
        """, (document_id, self.document_type)).fetchone()
    ...
    def mark_completed(self, document_id: str, processing_time_ms: Optional[int] = None) -> None:
        """
    ...
    def get_run_history(self, limit: int = 10) -> List[Dict[str, Any]]:
        ...
        runs = cursor.execute("""
            ...
            LIMIT ?
        """, (self.document_type, limit)).fetchall()
