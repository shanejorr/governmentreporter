...
class TestFederalRegisterClientConfiguration:
    ...
    def test_base_url_configuration(self, federal_register_client):
        ...
        # Assert
        assert federal_register_client._get_base_url() == "https://www.federalregister.gov/api/v1"
...
class TestGetExecutiveOrderText:
    ...
    def test_get_text_plain_format(self, federal_register_client):
        ...
        # Arrange
        raw_text_url = "https://www.federalregister.gov/documents/full_text/txt/test.txt"
    ...
    def test_get_text_with_html_entities(self, federal_register_client):
        ...
        respx.get(raw_text_url).mock(return_value=Response(200, text=html_with_entities))
    ...
    def test_get_text_404_error(self, federal_register_client):
        ...
        # Arrange
        raw_text_url = "https://www.federalregister.gov/documents/full_text/txt/missing.txt"
...
class TestGetExecutiveOrder:
    ...
    @respx.mock
    def test_get_executive_order_happy_path(self, federal_register_client, eo_metadata_payload):
        ...
        assert result["agencies"] == ["Executive Office of the President"]  # Extracted names
...
class TestListExecutiveOrders:
    ...
    def test_list_orders_single_page(self, federal_register_client):
        ...
        # Act
        orders = list(federal_register_client.list_executive_orders("2024-01-01", "2024-12-31"))
    ...
    def test_list_orders_with_pagination(self, federal_register_client):
        ...
        page1_results = {
            "results": [
                {"document_number": f"2024-{i:05d}", "title": f"Order {i}", "executive_order_number": 14000 + i}
        ...
        routes = [
            respx.get(url, params__contains={"page": 1}).mock(return_value=Response(200, json=page1_results)),
            respx.get(url, params__contains={"page": 2}).mock(return_value=Response(200, json=page2_results))
        ]
    ...
    def test_list_orders_with_max_results(self, federal_register_client):
        ...
        # Act
        orders = list(federal_register_client.list_executive_orders(
    ...
    def test_list_orders_invalid_date_format(self, federal_register_client):
        ...
        with pytest.raises(ValueError, match="Invalid start_date format"):
            list(federal_register_client.list_executive_orders("01/01/2024", "2024-12-31"))
        
        with pytest.raises(ValueError, match="Invalid end_date format"):
            list(federal_register_client.list_executive_orders("2024-01-01", "12/31/2024"))
...
class TestSearchDocuments:
    ...
    @respx.mock
    def test_search_documents_with_full_content(self, federal_register_client, eo_metadata_payload, eo_raw_text):
    ...
    def test_search_documents_error_handling(self, federal_register_client):
        ...
        search_results = {
            "results": [
                {"document_number": "2024-99999", "title": "Test Order"}
            ]
        }
        ...
        documents = federal_register_client.search_documents(
            query="test",
            limit=10,
            full_content=True  # Try to get full content
        )
...
class TestGetDocument:
    ...
    @respx.mock
    def test_get_document_happy_path(self, federal_register_client, eo_metadata_payload, eo_raw_text):
    ...
    @respx.mock
    def test_get_document_text_fetch_failure(self, federal_register_client, eo_metadata_payload):
...
class TestGetDocumentText:
    ...
    @respx.mock
    def test_get_document_text_happy_path(self, federal_register_client, eo_metadata_payload, eo_raw_text):
...
class TestExtractBasicMetadata:
    ...
    def test_extract_metadata_complete(self, federal_register_client, eo_metadata_payload):
    ...
    def test_extract_metadata_invalid_date(self, federal_register_client):
        ...
        # Assert
        assert metadata["signing_date"] == "not-a-date"  # Returns original if parsing fails
