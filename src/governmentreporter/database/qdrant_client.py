...
class QdrantDBClient:
    ...
    def get_or_create_collection(self, collection_name: str, vector_size: int = 768):
        """
        ...
        Args:
            ...
            vector_size (int, optional): Size of the vectors to be stored.
                Defaults to 768 (typical for sentence-transformers).
                Must match the embedding dimension used.
        ...
        Python Learning Notes:
            ...
            - Default parameters provide flexibility with sensible defaults

        Qdrant Concepts:
            - Collections organize similar documents (like database tables)
            - Vector size must be consistent within a collection
        ...
        Example:
            ...
            client.get_or_create_collection("federal_register", vector_size=1024)
        """
        try:
